...
public class RopeSkippingActivity extends NFCActivity {
	...
	private Logger log = Logger.getLogger(RopeSkippingActivity.class);
	...
	protected void initView() {
		...
		tvInfoTitle.setText("跳绳");
		tvInfoChengji.setText("跳绳");
	...
	private void setListener() {
		...
		rg.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				RadioButton radioButton = (RadioButton) RopeSkippingActivity.this

...
public class VolleyballActivity extends NFCActivity {
	...
	private Logger log = Logger.getLogger(VolleyballActivity.class);
	...
	private void readCard(Intent intent) {
		try {
			...
			log.info("排球读卡=>" + student.toString());
			if (1 == student.getSex()) {
				sex = "男";
			} else {
				sex = "女";
	...
	protected void initView() {
		...
		tvInfoTitle.setText("排球");
		tvInfoChengji.setText("排球");
	...
	private void setListener() {
		...
		rg.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				RadioButton radioButton = (RadioButton) VolleyballActivity.this
